...
const template = `<template>
    ...
    <div class="card-container">
        <div class="card-box card-vis" repeat.for="set of visibleSets; key.bind: set.__rid">
...
class Sets {
  constructor() {
    ...
    __publicField(this, "visibleSets", []);
