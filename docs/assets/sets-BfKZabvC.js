...
var _handleHideVanillaChanged_dec, _class_dec, _handleSearchChanged_dec, _hideVanilla_dec, _selectedEquipmentName_dec, _selectedType_dec, _search_dec, _Sets_decorators, _init;
_Sets_decorators = [customElement(__au2ViewDef)], _search_dec = [bindable], _selectedType_dec = [bindable], _selectedEquipmentName_dec = [bindable], _hideVanilla_dec = [bindable], _handleSearchChanged_dec = [watch("search")], _class_dec = [bindable], _handleHideVanillaChanged_dec = [watch("hideVanilla")];
class Sets {
  constructor() {
    ...
    __publicField(this, "class", __runInitializers(_init, 24, this)), __runInitializers(_init, 27, this);
  ...
  updateList() {
    try {
      ...
      const matchesVanilla = (set) => {
        ...
        return String(set?.Vanilla || "").toUpperCase() !== "Y";
      };
...
__decorateElement(_init, 1, "handleHideVanillaChanged", _handleHideVanillaChanged_dec, Sets);
