import { C as CustomElement, c as customElement, b as bindable } from "./index-DVnylFgu.js";
...
var _foundItems_dec, _selectedEquipmentName_dec, _selectedType_dec, _selectedClass_dec, _search_dec, _Grail_decorators, _init;
_Grail_decorators = [customElement(__au2ViewDef)], _search_dec = [bindable], _selectedClass_dec = [bindable], _selectedType_dec = [bindable], _selectedEquipmentName_dec = [bindable], _foundItems_dec = [bindable];
class Grail {
  constructor() {
    ...
    __publicField(this, "showFoundItems", false);
    __publicField(this, "foundItems", __runInitializers(_init, 24, this, {})), __runInitializers(_init, 27, this);
