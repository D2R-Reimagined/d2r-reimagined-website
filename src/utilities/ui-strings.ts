...
export const UI_STRINGS: Partial<Record<LanguageCode, Record<string, string>>> = {
    'deDE': {
        ...
        'ItemStats1b': 'Nicht identifiziert',
        ...
        'meleitype': 'Nahkampfwaffe',
        'amazitype': 'Amazonen-Gegenstand',
        'barbitype': 'Barbaren-Gegenstand',
        'druiitype': 'Druiden-Gegenstand',
        'necritype': 'Totenbeschwörer-Gegenstand',
        'palaitype': 'Paladin-Gegenstand',
    ...
    'enUS': {
        ...
        'meleitype': 'Melee Weapon',
        'amazitype': 'Amazon Item',
        'barbitype': 'Barbarian Item',
        'druiitype': 'Druid Item',
        'necritype': 'Necromancer Item',
        'palaitype': 'Paladin Item',
        'label_armors': 'Armors',
    ...
    'esES': {
        ...
        'meleitype': 'Arma cuerpo a cuerpo',
        'amazitype': 'Objeto de amazona',
        'barbitype': 'Objeto de bárbaro',
        'druiitype': 'Objeto de druida',
        'necritype': 'Objeto de nigromante',
        'palaitype': 'Objeto de paladín',
    ...
    'frFR': {
        ...
        'meleitype': 'Arme de mêlée',
        'amazitype': 'Objet d\'amazone',
        'barbitype': 'Objet de barbare',
        'druiitype': 'Objet de druide',
        'necritype': 'Objet de nécromancien',
        'palaitype': 'Objet de paladin',
    ...
    'itIT': {
        ...
        'meleitype': 'Arma da mischia',
        'amazitype': 'Oggetto per amazzone',
        'barbitype': 'Oggetto per barbaro',
        'druiitype': 'Oggetto per druido',
        'necritype': 'Oggetto per necromante',
        'palaitype': 'Oggetto per paladino',
    ...
    'jaJP': {
        ...
        'itype_any_helm': '全ての兜',
        'meleitype': '近接武器',
        'amazitype': 'アマゾン専用アイテム',
        'barbitype': 'バーバリアン専用アイテム',
        'druiitype': 'ドルイド専用アイテム',
        'necritype': 'ネクロマンサー専用アイテム',
        'palaitype': 'パラディン専用アイテム',
        'label_armors': '防具',
        'label_weapons': '武器',
        'label_prefix': '接頭辞',
        'label_suffix': '接尾辞',
    ...
    'plPL': {
        ...
        'ItemStats1b': 'Niezidentyfikowane',
        'app_brand': 'D2R Reimagined',
        'nav_wiki': 'Wiki',
        ...
        'meleitype': 'Broń do walki wręcz',
        'amazitype': 'Przedmiot Amazonki',
        'barbitype': 'Przedmiot Barbarzyńcy',
        'druiitype': 'Przedmiot Druida',
        'necritype': 'Przedmiot Nekromanty',
        'palaitype': 'Przedmiot Paladyna',
        'label_armors': 'Zbroje',
    ...
    'ptBR': {
        ...
        'meleitype': 'Arma Corpo a Corpo',
        'amazitype': 'Item de Amazona',
        'barbitype': 'Item de Bárbaro',
        'druiitype': 'Item de Druida',
        'necritype': 'Item de Necromante',
        'palaitype': 'Item de Paladino',
        'label_armors': 'Armaduras',
        'label_weapons': 'Armas',
    ...
    'ruRU': {
        ...
        'ItemStats1b': 'Неопознанный предмет',
        'app_brand': 'D2R Reimagined',
        'nav_wiki': 'Вики',
        ...
        'meleitype': 'Оружие ближнего боя',
        'amazitype': 'Предмет амазонки',
        'barbitype': 'Предмет варвара',
        'druiitype': 'Предмет друида',
        'necritype': 'Предмет некроманта',
        'palaitype': 'Предмет паладина',
        'label_armors': 'Броня',
